...
static TR::Register* inlineIntrinsicIndexOf(TR::Node* node, TR::CodeGenerator* cg, bool isLatin1)
   ...
   generateCompareBranchInstruction(cg, TR::InstOpCode::cbzw, node, tmp2Reg, loopLabel);
   ...
   generateLogicalShiftRightImmInstruction(cg, node, tmp1Reg, tmp1Reg, isLatin1 ? 2 : 3, /* is64bit */ true); // div by 4 or 8
