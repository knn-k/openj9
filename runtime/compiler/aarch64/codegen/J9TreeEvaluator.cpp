...
static TR::Register* inlineIntrinsicStringIndexOfString(TR::Node* node, TR::CodeGenerator* cg)
   ...
   TR::LabelSymbol *firstCharByteLoopLabel = generateLabelSymbol(cg);
   TR::LabelSymbol *firstCharVectorLoopLabel = generateLabelSymbol(cg);
   ...
   generateCompareBranchInstruction(cg, TR::InstOpCode::cbzw, node, tmp2Reg, firstCharVectorLoopLabel);
   ...
   generateLabelInstruction(cg, TR::InstOpCode::label, node, firstCharVectorLoopLabel);
   ...
   generateTrg1Src1ImmInstruction(cg, TR::InstOpCode::addimmw, node, resultReg, resultReg, vecWidth);
   generateCompareInstruction(cg, node, resultReg, maxReg, /* is64bit */ false);
   generateConditionalBranchInstruction(cg, TR::InstOpCode::b_cond, node, firstCharVectorLoopLabel, TR::CC_LE);
   ...
   generateTrg1Src1Instruction(cg, TR::InstOpCode::rbitx, node, tmp1Reg, tmp1Reg);
   generateTrg1Src1Instruction(cg, TR::InstOpCode::clzx, node, tmp1Reg, tmp1Reg);
   generateLogicalShiftRightImmInstruction(cg, node, tmp1Reg, tmp1Reg, 2, /* is64bit */ true);
