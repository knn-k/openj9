...
VMarrayCheckEvaluator(TR::Node *node, TR::CodeGenerator *cg)
   ...
   TR::addDependency(conditions, obj1Reg, TR::RealRegister::x0, TR_GPR, cg);
   TR::addDependency(conditions, obj2Reg, TR::RealRegister::x1, TR_GPR, cg);
   TR::addDependency(conditions, tmp1Reg, TR::RealRegister::x2, TR_GPR, cg);
   TR::addDependency(conditions, tmp2Reg, TR::RealRegister::x3, TR_GPR, cg);
   */
