...
private:
    ...
    /** \brief
     *     Transforms java/lang/StringLatin1.compareTo([B[B)I using arraycmplen
     *
     *  \param treetop
     *     The treetop which anchors the call node.
     *
     *  \param node
     *     The call node representing a call to java/lang/StringLatin1.compareTo([B[B)I which has the following shape:
     *
     *     \code
     *     icall <java/lang/StringLatin1.compareTo([B[B)I>
     *       <src byte array>
     *       <dst byte array>
     *     \endcode
     */
    void process_java_lang_StringLatin1_compareTo_BB(TR::TreeTop *treetop, TR::Node *node);
    /** \brief
