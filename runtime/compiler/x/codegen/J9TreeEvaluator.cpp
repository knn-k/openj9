...
static TR::Register* inlineIntrinsicStringIndexOfString(TR::Node* node, TR::CodeGenerator* cg, bool isLatin1)
   ...
   // s1len and s2len are in # of characters instead of bytes for UTF16 case
   ...
   //generateRegMemInstruction(TR::InstOpCode::MOVUPSRegMem, node, xmmReg1, generateX86MemoryReference(s1Reg, s1idxReg, shift, hdrSize, cg), cg);
