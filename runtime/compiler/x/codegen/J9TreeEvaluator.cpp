...
static TR::Register* inlineIntrinsicStringIndexOfString(TR::Node* node, TR::CodeGenerator* cg, bool isLatin1)
   ...
   TR::Register *s1lenReg = cg->evaluate(node->getChild(firstCallArgIdx+1));
   ...
   TR::Register *ECX = cg->allocateRegister();
   ...
   */
   ...
   auto hdrSize = TR::Compiler->om.contiguousArrayHeaderSizeInBytes();

   // load first char of s2 -- consider UTF16 case
   generateRegMemInstruction(TR::InstOpCode::L1RegMem, node, tmpReg1, generateX86MemoryReference(s2Reg, hdrSize, cg), cg);
   generateRegRegInstruction(TR::InstOpCode::MOVDRegReg4, node, xmmReg2, tmpReg1, cg);
   ...
   generateRegRegInstruction(TR::InstOpCode::SUB4RegReg, node, maxReg, s2lenReg, cg);
   ...
   generateRegMemInstruction(TR::InstOpCode::LEARegMem(), node, tmpReg1, generateX86MemoryReference(s1Reg, resultReg, shift, hdrSize, cg), cg);
   generateRegRegInstruction(TR::InstOpCode::MOVRegReg(), node, ECX, tmpReg1, cg);
   generateRegImmInstruction(TR::InstOpCode::ANDRegImms(), node, tmpReg1, ~(width - 1), cg);
   generateRegImmInstruction(TR::InstOpCode::ANDRegImms(), node, ECX, width - 1, cg);
   generateLabelInstruction(TR::InstOpCode::JE1, node, firstCharLoopLabel, cg);

   generateRegMemInstruction(TR::InstOpCode::MOVDQURegMem, node, xmmReg1, generateX86MemoryReference(tmpReg1, 0, cg), cg);
   generateRegRegInstruction(compareOp, node, xmmReg1, xmmReg2, cg);
   generateRegRegInstruction(TR::InstOpCode::PMOVMSKB4RegReg, node, tmpReg1, xmmReg1, cg);
   generateRegInstruction(TR::InstOpCode::SHR4RegCL, node, tmpReg1, cg);
   generateRegRegInstruction(TR::InstOpCode::TEST4RegReg, node, tmpReg1, tmpReg1, cg);
   ...
   generateRegImmInstruction(TR::InstOpCode::ADD4RegImms, node, resultReg, width >> shift, cg);
   generateRegRegInstruction(TR::InstOpCode::CMP4RegReg, node, resultReg, maxReg, cg);
   generateLabelInstruction(TR::InstOpCode::JL1, node, firstCharLoopLabel, cg);

   // first char matched
   generateLabelInstruction(TR::InstOpCode::label, node, firstCharMatchedLabel, cg);

   generateRegRegInstruction(TR::InstOpCode::BSF4RegReg, node, tmpReg1, tmpReg1, cg);
   if (shift)
      {
      generateRegImmInstruction(TR::InstOpCode::SHR4RegImm1, node, tmpReg1, shift, cg);
      }
   generateRegRegInstruction(TR::InstOpCode::ADDRegReg(), node, resultReg, tmpReg1, cg);

   generateRegRegInstruction(TR::InstOpCode::CMP4RegReg, node, resultReg, maxReg, cg);
   generateLabelInstruction(TR::InstOpCode::JG4, node, notFoundLabel, cg);

   // @@ need to consider UTF16 case
   ...
   generateRegRegInstruction(TR::InstOpCode::MOVRegReg(), node, tmpReg2, s2lenReg, cg);
   generateRegImmInstruction(TR::InstOpCode::SUBRegImm4(), node, tmpReg2, 1, cg); // 1st char has already matched
   generateRegImmInstruction(TR::InstOpCode::SHRRegImm1(), node, tmpReg2, 4, cg);
   ...
   generateRegRegInstruction(TR::InstOpCode::PMOVMSKB4RegReg, node, tmpReg1, xmmReg1, cg);
   generateRegImmInstruction(TR::InstOpCode::CMPRegImm4(), node, tmpReg1, 0xffff, cg);
   ...
   generateRegImmInstruction(TR::InstOpCode::SUBRegImm4(), node, tmpReg2, 1, cg);
   ...
   generateRegRegInstruction(TR::InstOpCode::MOVRegReg(), node, tmpReg2, s2lenReg, cg);
   generateRegImmInstruction(TR::InstOpCode::SUBRegImm4(), node, tmpReg2, 1, cg); // 1st char has already matched
   generateRegImmInstruction(TR::InstOpCode::ANDRegImm4(), node, tmpReg2, 0xf, cg);
