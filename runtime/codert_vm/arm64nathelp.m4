...
OLD_DUAL_MODE_HELPER_NO_RETURN_VALUE(jitMethodMonitorEntry,1)
OLD_DUAL_MODE_HELPER_NO_RETURN_VALUE(jitMonitorEntry,1)
OLD_DUAL_MODE_HELPER_NO_RETURN_VALUE(jitMethodMonitorExit,1)
OLD_DUAL_MODE_HELPER_NO_RETURN_VALUE(jitMonitorExit,1)
